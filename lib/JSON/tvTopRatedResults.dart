...
//
//     final tvTopRatedResults = tvTopRatedResultsFromJson(jsonString);
...
class TvTopRatedResults with ChangeNotifier {
  int page;
  List<Result> results;
  int totalResults;
  int totalPages;
  ...
  factory TvTopRatedResults.fromRawJson(String str) => TvTopRatedResults.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TvTopRatedResults.fromJson(Map<String, dynamic> json) => TvTopRatedResults(
  ...
  Future getMoreResults(page) async {
    ...
    var newData = await getTopRatedTv(page);
