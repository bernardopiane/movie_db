...
//
//     final airingToday = airingTodayFromJson(jsonString);
...
class AiringToday with ChangeNotifier {
  int page;
  List<Result> results;
  int totalResults;
  int totalPages;
  ...
  factory AiringToday.fromRawJson(String str) => AiringToday.fromJson(json.decode(str));
  ...
  Future getMoreResults(page) async {
    ...
    print("New Data Value: ${newData.toString()}");
