...
//
//     final moviesPopularResults = moviesPopularResultsFromJson(jsonString);
...
class MoviesPopularResults with ChangeNotifier{
  int page;
  List<Result> results;
  int totalResults;
  int totalPages;
  ...
  factory MoviesPopularResults.fromRawJson(String str) => MoviesPopularResults.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MoviesPopularResults.fromJson(Map<String, dynamic> json) => MoviesPopularResults(
  ...
  Future getMoreResults(page) async {
    ...
    var newData = await getPopularMovies(page);
